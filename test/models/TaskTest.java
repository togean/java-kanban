...
class TaskTest {
    ...
    void twoTasksIsEqualsIfItHasSameID() {
        Task newTask = new StandardTask("task1", managerForTasks.getTaskID(), "task1 details");
    ...
    void twoInstancesOfStandardTaskIsEqualsIfItHasSameID() {
        StandardTask newStandardtask = new StandardTask("StandardTask1", managerForTasks.getTaskID(), "StandardTask1 details");
    ...
    void twoInstancesOfEpicsIsEqualsIfItHasSameID() {
        Epic newEpic = new Epic("Epic1", managerForTasks.getTaskID(), "Epic1 details");
    ...
    void twoInstancesOfSubTasksIsEqualsIfItHasSameID() {
        Epic newEpic = new Epic("Epic1", managerForTasks.getTaskID(), "Epic1 details");//Сначала создаём эпик для связи с подзадачей
        managerForTasks.create(newEpic);
        SubTask newSubTask = new SubTask("SubTask1", managerForTasks.getTaskID(), "SubTask1 details", 0);
    ...
    void subtaskCanNotBeEpicForOtherSubtask(){
        ...
        SubTask newSubTask = new SubTask("SubTask1", managerForTasks.getTaskID(), "SubTask1 details", 0);
        managerForTasks.create(newSubTask);
        SubTask newSubTask2 = new SubTask("SubTask2", managerForTasks.getTaskID(), "SubTask2 details", 0);
        managerForTasks.create(newSubTask2);
        SubTask newSubTask3 = new SubTask("SubTask1", managerForTasks.getTaskID(), "SubTask1 details", 2);//Вторая подзадача создаётся с ID=2, по этому его тут и пробуем
    ...
    void canFindCreatedTaskByID(){
        ...
        SubTask newSubTask = new SubTask("SubTask1", managerForTasks.getTaskID(), "SubTask1 details", 1);
